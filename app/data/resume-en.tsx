...
export const DATA_EN = {
  ...
  about: [
    {
      text: "Since 2024, I have been deepening my fundamentals in ",
    },
    {
    ...
    {
      text: " by building various web applications. Although I am currently still studying Informatics at university, ",
    },
    {
      text: "I actively learn independently",
      highlight: true,
    },
    {
      text: " through personal projects and by exploring various technologies. Backed by that experience, I have been ",
    },
    {
      text: "trusted to develop web applications",
      highlight: true,
    },
    {
      text: " used by real-world users. I enjoy building applications that not only function well, but are also genuinely useful to their users.",
    },
  ],
  skills: [
