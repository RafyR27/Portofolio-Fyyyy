...
export default function ContactPage() {
  ...
  return (
    <main className="w-full min-h-screen flex flex-col items-center justify-center mb-10 gap-15 lg:px-12 px-5">
      <div className="max-w-3xl">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-10 space-y-6">
          ...
          <Button type="submit" className="w-full h-11 rounded-xl cursor-pointer">
